...
public class AddCustomerPage_01 {
	 public WebDriver ldriver;

	    public AddCustomerPage_01(WebDriver rdriver)
	    {
	        ldriver=rdriver;
	    ...
	    By lnkCustomers_menuitem=By.xpath("//*[@href='/Admin/Customer/List' or class='nav-icon far fa-dot-circle']");
